...
const taskIntegrations:Record<TaskIntegration,{name:string;mark:string;url:string;description:string}>={
  online_presence:{name:"SEO optimization",mark:"SEO",url:"https://locallift-audit.patduds.chatgpt.site",description:"Run a verified Google listing and website audit with LocalLift."},
  drybar_payroll:{name:"Payroll converter",mark:"PC",url:"https://drybar-payroll-converter.patduds.chatgpt.site",description:"Convert Booker reports into a human-reviewed Paychex import."},
};
