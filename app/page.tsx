...
export default function Home(){
  ...
  async function createTask(input?:{title:string;description:string;deadline:string|null;recurrenceType:"one_time"|"recurring";recurrenceEvery:number|null;recurrenceUnit:"day"|"week"|"month"|null;sourceThreadId?:string}){
    ...
    try{
      ...
      setSavedTasks(current=>[json.task!,...current]);setActiveTaskId(json.task.id);setCreatingTask(false);setView("tasks");setOpenId(null);setNewTaskTitle("");setNewTaskDescription("");setNewTaskDeadline("");setNewTaskRecurrenceType("one_time");setNewTaskRecurrenceEvery(1);setNewTaskRecurrenceUnit("week");setTaskMessages([]);
